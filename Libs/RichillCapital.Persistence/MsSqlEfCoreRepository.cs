...
public class MsSqlEfCoreRepository<TEntity> :
    IRepository<TEntity>
    where TEntity : class
{
    private readonly MsSqlEfCoreDbContext _dbContext;
    private readonly ISpecificationEvaluator _specificationEvaluator;

    public MsSqlEfCoreRepository(MsSqlEfCoreDbContext dbContext)
    : this(dbContext, SpecificationEvaluator.Default)
    {
    }

    public MsSqlEfCoreRepository(
        MsSqlEfCoreDbContext dbContext,
